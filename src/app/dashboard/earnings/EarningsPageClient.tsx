      ...
      <div className="container-responsive py-10">
        ...
        <div className="mb-10 animate-fade-in">
          <div className="inline-flex items-center gap-2 glass rounded-full px-4 py-2 mb-4">
            ...
            <span className="text-xs font-semibold text-neutral-300">{t('earnings.badge')}</span>
          </div>
          <h1 className="text-4xl font-black text-white mb-2">{t('earnings.title')}</h1>
        ...
        <div className="glass rounded-3xl p-8 animate-fade-in">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-white mb-2">{t('earnings.requestWithdrawal')}</h2>
              <p className="text-neutral-400 mb-6">
                {t('earnings.withdrawalDesc')} <span className="text-primary-400 font-bold">{t('earnings.minAmount')}</span>.
              </p>
              <button className="px-8 py-3 bg-gradient-to-r from-primary-400 to-primary-500 hover:from-primary-500 hover:to-primary-600 text-black font-bold text-sm rounded-xl transition-all shadow-lg shadow-primary-400/20 glow-sm flex items-center gap-2 group">
